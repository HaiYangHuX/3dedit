...
**参考项目：** `zhangbo126/threejs-3dmodel-edit`、公开版 `zhangbo126/ThreeFlow`、数字孪生 在线编辑器与 v4.0.6 文档
...
顶部工具栏包含项目和场景切换、保存状态、重置场景、变换模式、坐标空间、导入导出、截图、预览、发布、全屏；撤销/重做通过帮助页展示的 Ctrl/Cmd 快捷键触发。
